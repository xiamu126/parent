...
public class DeviceSubtitle implements Serializable {
    ...
    public static class Effect{
        ...
        public static class Type{
            public static final short HX = 0; // 呼吸灯
            public static final short PM = 1; // 跑马灯
            public static final short QC = 2; // 全彩灯
    ...
    public String toString() {
        try{
            ...
            short effectTotalCount = 1;
            short effectCurrentIndex = 0;
